...
class PromoHeader: UICollectionReusableView {
    ...
    let titleLabel = UILabel(text: "Dee October Deals", font: .systemFont(ofSize: 30, weight: .bold), numberOfLines: 2)
    ...
    override init(frame: CGRect) {
        ...
        stackView.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 14, paddingLeft: 24, paddingBottom: 24, paddingRight: 24)
