...
//
    ...
    let items = [
        SystemItem.init(title: "RESPIRATORY", image: .respiratory, description: "The respiratory system supplies oxygen; peppermint supports breathing", subDescription: "he respiratory system—lungs, airways, and trachea—delivers oxygen to your cells with every breath. Peppermint oil has long supported healthy breathing."),
        SystemItem.init(title: "REPRODUCTIVE", image: .reproductive, description: "Stress, toxins, and lifestyle can disrupt reproductive health. Essential oils support hormones, mood, and intimacy.", subDescription: "Cool down with ClaryCalm® or Peppermint Touch, diffuse calming oils, bathe with Lavender and Epsom salts, wear Neroli, Jasmine, or Rose Touch as perfume, and apply soothing oils like ClaryCalm or Clary Sage during your cycle."),
